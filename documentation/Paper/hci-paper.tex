...
\midrule 2 & $z = 289, p=0.22, d = 0.06$ & $t = -6.70, p < .001, d = -1.91$ & $z = 247.5, p = .08, d = 0.20$  \\
\midrule 5 & $z = 265, p=0.14, d =0.14$    & $z = 263, p = .192, d = 0.15$    & $z = 225.5, p < .03, d = 0.37$  \\
\midrule 8 & $z = 226, p<0.03, d=0.27$  & $t = 2.47, p < .02, d =  0.70$   & $z = 230, p < .05, d = 0.30 $   \\
\midrule 11 & $z=248, p <0.05, d=0.20$     & $t = 6.22, p < .001, d = 1.77$   & $z = 192.5, p < .01, d = 0.38$  \\
\midrule 14 & $z=211.5, p< 0.01, d = 0.31$ & $t = 7.97, p < .001, d = 2.27$   & $z = 190.5, p < .01, d = 0.38$  \\
\end{tabular}}
\end{table}
...
in tasks 3, 4, and 5. Except for task 2, these reported differences between the navigation methods are significant (see Table \ref{fig:burger-vs-swipe}).
\begin{table}[!h]
\centering
...
significant for all tasks except task 1, which is shown in Table \ref{fig:burger-vs-swipe}.
\begin{table}[!h]
\centering
...
Final question (1) was rated with 1.5 (SD: 1.058) for burger and 1.53 (SD: 1.29) for swipe on average. In total, three participants rated
it with four or more, one out of which rated it with 7. The overall mean of final question (2) was xx..xxx(SD x..xx), 9 of the participants rated it
...
High confidences for each task, which suggests that no participant felt overstrained by the tasks. 9 participants felt the study was too long, so they may have
been tired or bored at one point, which may or may not distort the results. However, making the study even shorter (it was about 5-8 minutes) was not possible, because
less tasks would have made it more difficult to find the intersect point. Question (3) may be a little unclear, as one participant mentioned that to him the difference
in meaning between question (3) and (4) was not clear. However, the difference is not significant, so we assume that the question was understood correctly by most participants.
