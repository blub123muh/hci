...
\begin{abstract}
  ...
  through the exam's questions sequentially, it is a common case that they want to revise their answers later due to a change of mind or a missunderstanding
...
\begin{figure}[h]
  ...
  \caption{Efficiency by distance with swipe navigation}\label{fig:swipebox}
\end{figure}
\begin{figure}[h]
  \centering
  \includegraphics[width=\columnwidth]{pics/swipe_boxplot.png}
  \caption{Efficiency by distance with burger menu navigation}\label{fig:burgerbox}
\end{figure}
On the one hand, the box plot of efficiency by distance for the swipe navigation
(see figure~\ref{fig:swipebox}) reveals heterogeneous variances,
no trend, and a single outlier at distance 11 (task 4) below the central value.

On the other hand, the box plot of efficiency by distance for the burger menu navigation
(see figure~\ref{fig:burgerbox}) reveals heterogeneous variances,
a descending trend, four outliers for distances 2, 5, and 14 (tasks 1, 2, and 5) below the central value,
and a single outlier at distance 14 (task 5) above the central value.
\todo{reread}
