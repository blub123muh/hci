...
\begin{figure*}
	...
	\label{fig:sequence}
\end{figure*}
In order to simulate the scenarios of jumping from one question to another, we develop a series of treasure hunt like tasks. Here, the goal is to find the treasure which is hidden behind a door. A door is represented by a page. The application was developed for Android devices.
...
\begin{figure}
	\centering
	\includegraphics[width=0.45\textwidth]{pics/screenshots/global3-cut}
...
\begin{figure}
	\centering
	\includegraphics[width=0.45\textwidth]{pics/screenshots/global5-cut}
...
Table \ref{fig:burger-vs-swipe} shows that the error rates were slightly lower for task 1 and task 5 than for the others. However, the differences
...
development of the means depending on the tasks is shown in Table \todo{make table}. \todo{Any tendency? Significances?}. When comparing the navigation methods with each other,
...
on average, respectively. See Table \todo{make table} for the statistics of individual tasks. It can be seen that \todo{what can be seen}.
\section{Discussion}
\subsection{Effectiveness}
