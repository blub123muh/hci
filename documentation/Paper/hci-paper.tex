...
\section{Discussion}
\paragraph{Study Design Validation}
The results for task question (1) clearly suggest, that the participants did not feel overstrained by the complexity of the tasks. The results of the person who indicated large
...
\paragraph{Summary}
While the speed aspect is taken into account for the efficiency in this study, systematically investigating how making those types of errors is perceived by the users
may be an interesting object of investigation in future work. intersect point?
